<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InsidePhotos.aspx.cs" Inherits="Web.Gallery.InsidePhotos" %>
...
<div class="row-fluid">
<div class="span10">
<h2>Photos of the children inside playing</h2>
</div>
</div>
<div class="row-fluid">
<div class="span10">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    ...
                    <div class="carousel-caption">
                      <p>Construction and cooperative play</p>
                    </div>
                  </div>
                  <div class="item">
                  ...
                  <div class="item">
                    ...
                    <div class="carousel-caption">
                      <p>Primary caregiving - developing a sense of belonging</p>
                    </div>
                  </div>
                  </div>
