...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentChild" runat="server">
    <div class="row-fluid">
        <div class="span10">
            <h2>
                What is an individual profile?</h2>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span6">
            <p>
                Individual profile is a collection of information about your child during his/her
                time at crèche.</p>
            <p>
                It is information that the crèche Teachers would like to share with parents/caregivers
                to inform you how your child is progressing at crèche.
            </p>
            <p>
                Staff will use a variety of techniques and methods to collect information e.g. samples
            ...
            <p>
                ...
                forms and comments in the Feedback forms in the children's profiles. If you want
                to see your child's Individual Profile at any time just let one of the teachers
                know or you can access it by the front door below the children's individual pockets.
                If you do not wish us to develop a Profile of your child please also let us know.</p>
            <p>
            ...
            <div id="myModal" class="modal hide fade wide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                        ×</button>
                    <h3 id="myModalLabel">
                        An Individual profile</h3>
                </div>
                <div class="modal-body">
                    <p>
                        As a nice memento from MCC and a way of seeing what your child does at crèche we
                        construct a profile all about them and their experiences.</p>
    ...
    <div class="row-fluid">
        <div class="span10">
            <h4>
                Download forms</h4>
            <p>
                If you require any forms for your child's profile or want to take a look at what
                we include you can download the forms here.</p>
            <a href="/files/WhanauFamilyVoice.docx" class="btn btn-warning">Download Whanau Family
                voice</a> <a href="/files/Individual profile sheet.docx" class="btn btn-warning">Download
                    Individual profile sheet</a>
        </div>
    </div>
</asp:Content>
