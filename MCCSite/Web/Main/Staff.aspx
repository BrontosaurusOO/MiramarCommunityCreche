    ...
    <div class="row-fluid">
        <div class="span10" id="staffWelcome">
            <p>
                ...
                is absent and currently we have a volunteer that works two days at the crèche who
                ...
                <ul class="thumbnails">
                    <li class="span4">
                        <div class="thumbnail">
                            ...
                            <p class="staff-attributes">
                                <strong>Qualifications:</strong> Diploma of Teaching ECE and full teacher registration.
                                First Aid</p>
                            <p class="staff-attributes">
                    ...
                    <li class="span4">
                        <div class="thumbnail">
                            ...
                            <p class="staff-attributes">
                                <strong>Qualifications:</strong> Diploma Teaching ECE, full teacher registration.
                                First Aid</p>
                            <p class="staff-attributes">
                                <strong>Years of service:</strong> 3 years</p>
                        </div>
                    </li>
                    <li class="span4">
                        <div class="thumbnail">
                            ...
                            <strong>Teacher</strong>
                            <p class="staff-attributes">
                                <strong>Qualifications:</strong> BA Graduate Diploma Teaching ECE and Full teacher
                                registration. First Aid
                            </p>
                            <p class="staff-attributes">
                                <strong>Years of service:</strong> 7 years</p>
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <ul class="thumbnails">
                    <li class="span4">
                        <div class="thumbnail">
                            ...
                            <strong>Teacher</strong>
                            <p class="staff-attributes">
                                <strong>Qualifications:</strong> Bachelor of Education Teaching ECE, Diploma Teaching
                                ECE and full teacher registration</p>
                            <p class="staff-attributes">
                    ...
                    <li class="span4">
                        <div class="thumbnail">
                            ...
                            <p class="staff-attributes">
                                <strong>Qualifications:</strong> Bachelor of Education Teaching Early Childhood</p>
                            <p class="staff-attributes">
